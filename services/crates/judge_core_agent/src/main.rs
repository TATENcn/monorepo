use judge_core_agent::{AgentError, verdict::handle};
use judge_core_shared::{
    models::VerdictTask,
        ...
        tasks.spawn(async move {
            let result = async {
                ...
                let res = match task.language {
                    judge_core_shared::models::Language::Cpp => handle::<judge_core_agent::verdict::cpp::Cpp>(id, task).await,
                };
